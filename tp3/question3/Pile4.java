...
public class Pile4<T> implements PileI<T>, Cloneable {
     ...
     */
    private static class Maillon<T> implements Cloneable {
        private T element;
    ...
    public T sommet() throws PileVideException {
        ...
        Maillon<T> tmp = this.stk;
        return tmp.element ; // à compléter
    }
